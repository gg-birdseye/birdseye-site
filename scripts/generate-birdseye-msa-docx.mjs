...
const msa = (signatureImageData, signatureDimensions) => [
  ...
  p([bold("(a) Plan A — Annual/Upfront Plan: "), t("The Subscription automatically renews for successive twelve (12) month periods. Client shall be automatically charged the Year 2 and later annual subscription fee specified in Schedule A on each annual renewal date.")]),
  p([bold("(b) Plan B — Monthly Plan: "), t("The Subscription automatically renews on a month-to-month basis. Client shall be automatically charged the Year 2 and later monthly subscription fee specified in Schedule A on each monthly renewal date.")]),
  p("Renewal fees shall be the Year 2 and later rates specified in Schedule A, unless otherwise agreed in writing. Birdseye shall provide written notice of any rate change at least thirty (30) days prior to the effective date of the new rate for a Renewal Term."),
  ...
  p(`Year 1 (Initial Term) subscription: ${mf("SubscriptionTotal")}`),
  ...
  p(`Year 2 and later (renewal) subscription: ${mf("RenewalTotal")}`),
  p("After Initial Term: Subscription automatically renews at the Year 2 and later rate specified above, per MSA Article 7.5, unless Client cancels at least 30 days before the next renewal date."),
  blank(),
